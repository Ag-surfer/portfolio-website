    ...
    roadmap: [
      ...
      },
      {
        ...
        topics: [
          ...
          { title: 'Normalization (1NF–3NF)', description: 'Organizing data to eliminate redundancy and prevent update anomalies. Normalization keeps your data consistent and your storage efficient.' },
